...
$(function(){
    ...
    jQuery.validator.addMethod("isHref", function(value, element, param) {
        var isHref = /^((https|http|ftp|rtsp|mms)?:\/\/)[^\s]+/;  
        return this.optional(element)||(isHref.test(value));  
	}, $.validator.format("请输入合规的网络地址!"));
